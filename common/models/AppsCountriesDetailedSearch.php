...
/**
 * AppsCountriesDetailedSearch represents the model behind the search form of `common\models\AppsCountriesDetailed`.
 */
class AppsCountriesDetailedSearch extends AppsCountriesDetailed
{
    ...
    public function rules()
    {
        return [
            ...
            [['countryCode', 'countryName', 'currencyCode', 'fipsCode', 'isoNumeric', 'north', 'south', 'east', 'west', 'capital', 'continentName', 'continent', 'languages', 'isoAlpha3', 'telephonePrefix'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'countryCode', $this->countryCode])
            ...
            ->andFilterWhere(['like', 'telephonePrefix', $this->telephonePrefix]);
